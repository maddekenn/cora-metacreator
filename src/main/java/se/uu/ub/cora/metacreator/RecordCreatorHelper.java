...
public class RecordCreatorHelper {
    ...
    public RecordCreatorHelper(String authToken, SpiderDataGroup spiderDataGroup, String implementingTextType) {
        this.authToken = authToken;
        this.spiderDataGroup = spiderDataGroup;
        this.implementingTextType = implementingTextType;
    }

    public static RecordCreatorHelper withAuthTokenSpiderDataGroupAndImplementingTextType(String authToken, SpiderDataGroup spiderDataGroup, String implementingTextType) {
