...
public class CollectionVariableConstructor {
    ...
    private SpiderDataGroup createSpiderDataGroup(String id, String nameInData, String dataDivider, String refCollection) {
    ...
    private void addChildren(String id, String nameInData, String dataDivider, String refCollection) {
    ...
    private void createAndAddRecordInfo(String id, String dataDivider, SpiderDataGroup collectionVar) {
    ...
    private void addRefCollection(String refCollection) {
        ...
        refCollectionGroup.addChild(SpiderDataAtomic.withNameInDataAndValue("linkedRecordType", "metadataItemCollection"));
        refCollectionGroup.addChild(SpiderDataAtomic.withNameInDataAndValue("linkedRecordId", refCollection));
