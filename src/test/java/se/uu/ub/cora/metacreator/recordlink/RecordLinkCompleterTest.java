...
public class RecordLinkCompleterTest {
	...
	public void testRecordLinkWithNoTexts() {
		...
		assertEquals(textIdGroup.getFirstAtomicValueWithNameInData("linkedRecordId"), "someRecordLinkText");
		...
		assertEquals(defTextIdGroup.getFirstAtomicValueWithNameInData("linkedRecordId"), "someRecordLinkDefText");
